...
public class AgentComponent implements ClusterComponent {
    ...
    @Override
    public void apply(VmClusterEntity cluster, java.util.function.Supplier<Map<String, Object>> outputs) {
    ...
    @Override
    public ComponentProbe probe(VmClusterEntity cluster, java.util.function.Supplier<Map<String, Object>> outputs) {
        try {
