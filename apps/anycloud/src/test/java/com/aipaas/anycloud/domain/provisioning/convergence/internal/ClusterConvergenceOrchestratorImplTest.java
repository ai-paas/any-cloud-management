...
class ClusterConvergenceOrchestratorImplTest {
    ...
    private final com.aipaas.anycloud.domain.operation.OperationService operationService =
            mock(com.aipaas.anycloud.domain.operation.OperationService.class);
    private final ClusterConvergenceOrchestratorImpl orchestrator = new ClusterConvergenceOrchestratorImpl(
            observer, addonInspector, repository, repairService, operationService);
