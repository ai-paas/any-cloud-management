...
public class AgentCommandRouter {
    ...
    public AgentCommandRouter(
            AgentSessionRegistry sessionRegistry, ObjectProvider<ImpersonationContext> impersonationContextProvider) {
    ...
    public CompletableFuture<CommandResponse> getLog(
            String clusterName,
            String namespace,
            String podName,
            String container,
        ...
        Struct params = struct(Map.of(
                ...
                "tailLines",
                String.valueOf(tailLines),
                "previous",
                String.valueOf(previous),
                "sinceSeconds",
                String.valueOf(sinceSeconds)));
    ...
    public CompletableFuture<CommandResponse> deleteResource(
            String clusterName, String namespace, String kind, String name) {
        Struct params = struct(Map.of(
    ...
    public CompletableFuture<CommandResponse> getResource(
            String clusterName, String namespace, String kind, String name) {
        Struct params = struct(Map.of(
                "namespace", namespace == null ? "" : namespace,
                "kind", kind == null ? "" : kind,
    ...
    public CompletableFuture<CommandResponse> listResources(
    ...
    public CompletableFuture<CommandResponse> applyManifest(
            String clusterName, String namespace, String manifest, boolean force) {
        return applyManifest(clusterName, namespace, manifest, force, false);
    }

    /** APPLY_MANIFEST with dry-run. */
    public CompletableFuture<CommandResponse> applyManifest(
            String clusterName, String namespace, String manifest, boolean force, boolean dryRun) {
        Struct params = struct(Map.of(
                "namespace",
                namespace == null ? "" : namespace,
                "manifest",
     ...
     */
    public CompletableFuture<CommandResponse> installAddon(
            String clusterName,
            String releaseName,
            String chart,
            String repoUrl,
            String chartTarballBase64,
            String version,
            String namespace,
            String valuesJson,
     ...
     */
    public CompletableFuture<CommandResponse> upgradeAddon(
            String clusterName,
            String releaseName,
            String chart,
            String repoUrl,
     ...
     */
    public CompletableFuture<CommandResponse> uninstallAddon(
            String clusterName, String releaseName, String namespace, boolean keepHistory, boolean wait) {
        Struct params = struct(Map.of(
                "release",
     ...
     */
    public CompletableFuture<CommandResponse> listHelmReleaseResources(
            String clusterName, String namespace, String release) {
        Struct params = struct(Map.of(
                "namespace", namespace == null ? "" : namespace,
    ...
    public CompletableFuture<CommandResponse> getHelmReleaseStatus(
            String clusterName, String namespace, String release) {
        Struct params = struct(Map.of(
                "namespace", namespace == null ? "" : namespace,
                "release", release == null ? "" : release));
     ...
     */
    public CompletableFuture<CommandResponse> getHelmReleaseHistory(
            String clusterName, String namespace, String release, int max) {
        Struct params = struct(Map.of(
                "namespace", namespace == null ? "" : namespace,
                "release", release == null ? "" : release,
     ...
     */
    public CompletableFuture<CommandResponse> rollbackHelmRelease(
            String clusterName, String namespace, String release, int revision, boolean wait) {
        Struct params = struct(Map.of(
                "namespace",
                namespace == null ? "" : namespace,
                "release",
     ...
     */
    public CompletableFuture<CommandResponse> applyAgentConfig(
            String clusterName,
            String allowedNamespacesJson,
            String allowedCommandsJson,
            String allowedChartsJson,
            String allowedExecNamespacesJson,
            String resourcePolicyYaml) {
        return applyAgentConfig(
                clusterName,
                allowedNamespacesJson,
                allowedCommandsJson,
                allowedChartsJson,
                allowedExecNamespacesJson,
                resourcePolicyYaml,
                null);
    }
    ...
    public CompletableFuture<CommandResponse> send(
            String clusterName, CommandType type, Struct params, int timeoutSeconds) {
        CommandRequest.Builder cmdBuilder =
                CommandRequest.newBuilder().setType(type).setParams(params).setTimeoutSeconds(timeoutSeconds);
    ...
    private void applyImpersonation(CommandRequest.Builder cmdBuilder, String clusterName, CommandType type) {
        ...
        log.debug(
                "dispatch with impersonation cluster={} type={} user={} groups={}",
                clusterName,
                type,
                id.user(),
                groups);
