...
public class ClusterAgentAutoConfiguration {
    ...
    @Bean
    @ConditionalOnMissingBean
    public AgentCommandRouter agentCommandRouter(
    ...
    public AgentHealthService agentHealthService(
        ...
        return new AgentHealthService(
                props.health().heartbeatStalenessThreshold(), identityStore, sessionRegistry, clock);
    }
    ...
    @Bean
    @ConditionalOnMissingBean
    public AgentIdentityAuthenticator agentIdentityAuthenticator(AgentIdentityStore identityStore, Clock clock) {
    ...
    public PodLogStreamService podLogStreamService(
            ...
            ClusterAgentProperties props) {
        return new PodLogStreamService(
                sessionRegistry, agentSessionRegistry, props.routing().enabled());
    }
    ...
    static class WebSocketConfig implements WebSocketConfigurer {
        ...
        public void registerWebSocketHandlers(WebSocketHandlerRegistry registry) {
            registry.addHandler(handler, props.exec().websocketPathPattern()).setAllowedOriginPatterns("*");
        }
