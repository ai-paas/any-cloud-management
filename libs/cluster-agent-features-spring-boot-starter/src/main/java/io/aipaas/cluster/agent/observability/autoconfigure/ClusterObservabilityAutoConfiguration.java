...
public class ClusterObservabilityAutoConfiguration {
    ...
    public ObservabilityQueryService observabilityQueryService(
            AgentSessionRegistry sessionRegistry, ClusterCatalog catalog, ObservabilityProperties props) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public DashboardLocator dashboardLocator(AgentSessionRegistry sessionRegistry, ObservabilityProperties props) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public HelmReleaseLookup helmReleaseLookup(AgentSessionRegistry sessionRegistry, ObservabilityProperties props) {
